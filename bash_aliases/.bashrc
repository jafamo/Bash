...
#export PATH="$PATH:$HOME/Programing/workspace/Bash/system"
...
#export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/var/lib/gems/2.1.0//bin"
